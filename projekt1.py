...
with DAG(
    ...
    params={
      "dags_home": Param("/home/olesik_andrei/airflow/dags", type="string"),
      "input_dir": Param("gs://fsbd23/project1/input", type="string"),
      "output_mr_dir": Param("/project1/output_mr3", type="string"),
      "output_dir": Param("gs://fsbd23/result/airflow", type="string"),
